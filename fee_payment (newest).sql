...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2018 at 02:01 PM
...
(4, 9, 16, 'Pjdssdiurtrhhtht', 1, 0, 'assets/catlogo/agrii.png', '2018-04-04'),
...
(85, 9, 16, 'Without image', 1, 1, '', '2018-04-17');
...
(4, 'Ldfsonoin', 'Oinionion', 'Ionoin', 'Nursery 3', '', 'kldflfnlonfpfd', 1, 7, '', '2018-01-04'),
...
--
ALTER TABLE `category_table`
  MODIFY `cat_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
--
...
--
ALTER TABLE `fee_table`
  MODIFY `fee_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
