...
<html class="no-js" lang="en">
                    ...
                    <section class="section">
                        ...
                        <div class="card card-block sameheight-item">
                            <div class="title-block">
                                <h1 class="title" align="center"><i class="fa fa-table"></i>   Transaction <a href="payitem.php" class="btn btn-primary pull-right"><i class="fa fa-list"></i>  Payment Module</a></h1>
                            </div>
 ...
 <div class="table-responsive">
   ...
   $sn=1;
   $newquery="select cart_table.*,transact_table.* from cart_table inner join transact_table on cart_table.student_sch=transact_table.sch_name and cart_table.student_id=transact_table.std_id group by transact_table.tr_id";
