...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2019 at 10:36 AM
...
(30, 71, 8, 'Honey Junior', 'JSS 3 ', 'Ckjcbbkjb', '10000.00', '10000.00', 0, '2019-01-04'),
(32, 6, 5, 'Honey Junior', 'JSS 3 ', 'Ckjcbbkjb', '10000.00', '10000.00', 0, '2019-02-08'),
(33, 6, 7, 'Honey Junior', 'SSS 3 ', 'Ckjcbbkjb', '20000.00', '20000.00', 0, '2019-02-08');
...
(87, 9, 16, 'Prime', 1, 1, 'assets/catlogo/logo.png', '2018-05-30'),
(88, 1, 16, 'PTA Levy', 1, 1, '', '2018-05-30'),
(89, 10, 16, 'Waec', 1, 1, '', '2018-05-30'),
(90, 10, 16, 'Practical', 1, 1, 'assets/catlogo/IMG-20161203-WA0000.jpg', '2018-05-30'),
(91, 10, 16, 'Another Tesr', 1, 1, '', '2018-05-30');
...
(71, 'Olumide', 'Adeosun', 'nicon@localhost.peerpay', '07087477282', 'parent', 1, 'f5e721b532126ac200aa629dbc44e4a982161242827b703e6acf9c726942a1e4', 1, '$2y$10$PXrT1Icg8GBqRona.b90reEBOAfUqy6dLENprL5JWOSZ.uo/yWCVm', '', '2019-01-04');
...
(6, 'Adeniran', 'Olu', 'Eze', 'JSS 2', '', 'Oritamefa', 0, 6, '', '2018-04-03'),
(7, 'Adeniran', 'Asala', 'Nm', 'SSS 3', '', 'Honey Junior', 1, 6, '', '2018-04-18'),
(8, 'Adeosun', 'Emmanuell', 'Olabisi', 'JSS 3', '', 'Honey Junior', 0, 71, '', '2019-01-04');
...
(111, 90, 10, 16, 'JSS 1', '250000.00', '2018-05-30'),
(112, 90, 10, 16, 'JSS 2', '35000.00', '2018-05-30'),
(113, 90, 10, 16, 'JSS 3', '45000.00', '2018-05-30'),
(114, 90, 10, 16, 'SSS 1', '55000.00', '2018-05-30'),
(115, 90, 10, 16, 'SSS 2', '65000.00', '2018-05-30'),
(116, 90, 10, 16, 'SSS 3', '70000.00', '2018-05-30'),
(135, 89, 10, 16, 'JSS 1', '35000.00', '2018-05-30'),
(136, 89, 10, 16, 'JSS 2', '35000.00', '2018-05-30'),
(137, 89, 10, 16, 'JSS 3', '35000.00', '2018-05-30'),
(138, 89, 10, 16, 'SSS 1', '60000.00', '2018-05-30'),
(139, 89, 10, 16, 'SSS 2', '60000.00', '2018-05-30'),
(140, 89, 10, 16, 'SSS 3', '60000.00', '2018-05-30'),
(165, 10, 10, 16, 'JSS 1', '35000.00', '2018-05-30'),
(166, 10, 10, 16, 'JSS 2', '35000.00', '2018-05-30'),
(167, 10, 10, 16, 'JSS 3', '35000.00', '2018-05-30'),
(168, 10, 10, 16, 'SSS 1', '35000.00', '2018-05-30'),
(169, 10, 10, 16, 'SSS 2', '35000.00', '2018-05-30'),
(170, 10, 10, 16, 'SSS 3', '35000.00', '2018-05-30'),
(171, 91, 10, 16, 'JSS 1', '35000.00', '2018-05-30'),
(172, 91, 10, 16, 'JSS 2', '0.00', '2018-05-30'),
(173, 91, 10, 16, 'JSS 3', '0.00', '2018-05-30'),
(174, 91, 10, 16, 'SSS 1', '0.00', '2018-05-30'),
(175, 91, 10, 16, 'SSS 2', '0.00', '2018-05-30'),
(176, 91, 10, 16, 'SSS 3', '0.00', '2018-05-30'),
(177, 50, 10, 16, 'JSS 1', '60000.00', '2018-05-30'),
(178, 50, 10, 16, 'JSS 2', '60000.00', '2018-05-30'),
(179, 50, 10, 16, 'JSS 3', '60000.00', '2018-05-30'),
(180, 50, 10, 16, 'SSS 1', '60000.00', '2018-05-30'),
(181, 50, 10, 16, 'SSS 2', '60000.00', '2018-05-30'),
(182, 50, 10, 16, 'SSS 3', '60000.00', '2018-05-30');
...
(1, '574981690', 6, 5, 9, 'Honey Junior', 'Card Payment', 0, '2018-05-22'),
(2, '574981690', 6, 7, 9, 'Honey Junior', 'Card Payment', 0, '2018-05-22'),
...
--
ALTER TABLE `category_table`
  MODIFY `cat_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
--
-- AUTO_INCREMENT for table `feeclient_table`
--
ALTER TABLE `feeclient_table`
  MODIFY `feeclient_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
...
--
ALTER TABLE `feestudent_table`
  MODIFY `std_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `fee_table`
--
ALTER TABLE `fee_table`
  MODIFY `fee_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
--
